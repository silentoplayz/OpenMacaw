    ...
    <div className="p-6">
      ...
      {showForm && (
        <div className="mb-6 p-4 bg-zinc-50 dark:bg-zinc-900/50 rounded-lg border border-gray-200 dark:border-white/10 shadow-sm">
          <h2 className="text-lg font-semibold mb-4 text-white">Add MCP Server</h2>
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 bg-zinc-900 border border-white/10 text-white placeholder-zinc-500 rounded-lg focus:outline-none focus:ring-1 focus:ring-cyan-500 focus:border-cyan-500"
                required
              />
            </div>
            <div>
              ...
              <select
                ...
                className="w-full px-3 py-2 bg-zinc-900 border border-white/10 text-white rounded-lg focus:outline-none focus:ring-1 focus:ring-cyan-500 focus:border-cyan-500"
              >
            ...
            <div>
              <label className="block text-sm font-medium text-gray-400 mb-1">Arguments (JSON array)</label>
              <input
                type="text"
                value={formData.args}
                onChange={(e) => setFormData({ ...formData, args: e.target.value })}
                placeholder='["-y", "some-mcp-server"]'
                className="w-full px-3 py-2 bg-zinc-900 border border-white/10 text-white placeholder-zinc-500 rounded-lg focus:outline-none focus:ring-1 focus:ring-cyan-500 focus:border-cyan-500 font-mono text-sm"
              />
            </div>
            <div className="flex gap-2">
              ...
              <button
                ...
                className="px-4 py-2 border border-white/10 text-gray-400 rounded-lg hover:bg-white/5 hover:text-white transition-colors"
              >
                Cancel
              </button>
            </div>
            ...
            <tbody className="divide-y divide-white/5">
              {servers?.map((server) => (
                <tr key={server.id} className="hover:bg-white/[0.03] transition-colors">
                  ...
                  <td className="px-4 py-3 text-gray-400">{server.transport}</td>
